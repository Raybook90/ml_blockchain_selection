...
def get_blocktime_cardano():
    ...
    # print(datetime.utcfromtimestamp(blocktime_UNIX_current).strftime('%H:%M:%S'))
    # print(datetime.utcfromtimestamp(blocktime_UNIX_previous).strftime('%H:%M:%S'))
